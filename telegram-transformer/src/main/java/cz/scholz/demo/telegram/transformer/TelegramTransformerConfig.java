...
public class TelegramTransformerConfig {
    ...
    private final String sentimentAnalysisTopic;
    private final String objectDetectionTopic;
    ...
    public TelegramTransformerConfig(String telegramApiKey, String bootstrapServers, String applicationId, String sourceTopic, String sentimentAnalysisTopic, String objectDetectionTopic, int commitIntervalMs, String trustStorePassword, String trustStorePath, String keyStorePassword, String keyStorePath, String additionalConfig) {
        this.telegramApiKey = telegramApiKey;
        this.bootstrapServers = bootstrapServers;
        this.applicationId = applicationId;
        this.sourceTopic = sourceTopic;
        this.sentimentAnalysisTopic = sentimentAnalysisTopic;
        this.objectDetectionTopic = objectDetectionTopic;
    ...
    public static TelegramTransformerConfig fromEnv() {
        String telegramTokenProperties = System.getenv("TELEGRAM_API_KEY");
        String telegramApiKey = telegramTokenProperties.substring(telegramTokenProperties.indexOf("=") + 1);

        String bootstrapServers = System.getenv("BOOTSTRAP_SERVERS");
        String sourceTopic = System.getenv("SOURCE_TOPIC");
        String sentimentAnalysisTopic = System.getenv("SENTIMENT_ANALYSIS_TOPIC");
        String objectDetectionTopic = System.getenv("OBJECT_DETECTION_TOPIC");
        ...
        return new TelegramTransformerConfig(telegramApiKey, bootstrapServers, applicationId, sourceTopic, sentimentAnalysisTopic, objectDetectionTopic, commitIntervalMs, trustStorePassword, trustStorePath, keyStorePassword, keyStorePath, additionalConfig);
    }
    ...
    public String getSentimentAnalysisTopic() {
        return sentimentAnalysisTopic;
    }

    public String getObjectDetectionTopic() {
        return objectDetectionTopic;
    }
    ...
    public String toString() {
        return "KafkaStreamsConfig{" +
            ...
            ", sentimentAnalysisTopic='" + sentimentAnalysisTopic + '\'' +
            ", objectDetectionTopic='" + objectDetectionTopic + '\'' +
