...
public class SentimentAnalysisConfig {
    private static final Logger log = LogManager.getLogger(SentimentAnalysisConfig.class);
    ...
    public static Properties createProperties(SentimentAnalysisConfig config) {
